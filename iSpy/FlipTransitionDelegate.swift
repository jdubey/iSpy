...
class FlipTransitionAnimator: NSObject, UIViewControllerAnimatedTransitioning {
    ...
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        if toViewController.view.snapshotView(afterScreenUpdates: true) != nil {
        ...
        let fromTransform = CATransform3DMakeRotation(-(CGFloat)(Double.pi / 2), 0.0, 1.0, 0.0)
        let toTransform = CATransform3DMakeRotation(0.0, 0.0, 1.0, 0.0)
